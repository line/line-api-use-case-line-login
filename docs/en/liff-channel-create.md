...
1. Create a channel for the Messaging API
   ...
   1. The screen of the created channel will appear as shown in the image below, confirming that the channel creation is complete..  
      ...
      *Take note of the channel secret displayed on the channel basic settings tab and the channel access token displayed on the Messaging API settings tab as they will be used in the following steps.
